package com.nazarkopelchak.core.presentation.designsystem
...
fun RuniqueTheme(
    ...
    if (!view.isInEditMode) {
        SideEffect {
            ...
            WindowCompat.getInsetsController(window, view).isAppearanceLightStatusBars = false  // this is used to adjust the color of status bar icons
        }
    }
